/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: dfef91296478d62794de8de50c4b22c4)
// Runtime types generated with workerd@1.20260921.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	...
	ADMIN_TOKEN: "";
	LOCAL_ADMIN: string;
	ROOMS: DurableObjectNamespace<import("./src/server").GameRoom>;
	PLAYERS: DurableObjectNamespace<import("./src/server").PersistentPlayer>;
	MATCHMAKER: DurableObjectNamespace<import("./src/server").Matchmaker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GameRoom" | "PersistentPlayer" | "Matchmaker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVELOPMENT" | "DEV_TOKEN" | "ADMIN_TOKEN" | "LOCAL_ADMIN">> {}
}
